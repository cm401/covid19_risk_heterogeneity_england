...
ggsave("figure3.png", plot = plot_variant_period_simple, width = 12, height = 8)
ggsave("figure3_SI.png", plot = plot_variant_period_SI, width = 12, height = 8)
ggsave("figure_vaccination.png", plot = vacc_status, width = 12, height = 4)
ggsave("figureSI_vaccination.png", plot = plot_vacc_SI, width = 12, height = 12)
ggsave("figure_restriction.png", plot = res, width = 12, height = 2)
...
for(IMD_subcomponent in IMD_subcomponents)
{
  ...
  ggsave(paste0("figureSI_", str_to_lower(str_replace(IMD_subcomponent,"_national_quintile","")),".png"), plot = plot_variant_subcomp, width = 12, height = 14)
}
...
ggsave("figureSI_nejm_vacc.png", plot = vacc, width = 12, height = 5)
...
write.table(nejm_vacc_table,'nejm_vacc_table.csv', sep = ',',
            row.names = FALSE, col.names = FALSE, quote = FALSE)
